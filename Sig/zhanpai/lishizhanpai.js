const svgmoban = [
    ...
    `;}.luhao{text-anchor:middle;font-family:Bahnschrift;font-size:16pt;fill:#fff;}.chezhan{font-size:16px;font-family:'未来荧黑';font-weight:700;}.zhushi{writing-mode:tb;text-orientation:upright;font-size:9px;font-family:'kGlowSansSCExtendedBook';font-weight:400;text-anchor:middle}.fangxianglat,.fangxiang,.tishi{font-family:Bahnschrift,MiSans;font-weight:500;fill:#fff}.fangxiang{font-size:18px;}.fangxianglat{font-size:9pt;fill:`,
...
function xiazaidanzhangsvg() {
    ...
    linshilianjie.download = zm[dangqianzhan] + '.svg'
    // 隐藏链接
